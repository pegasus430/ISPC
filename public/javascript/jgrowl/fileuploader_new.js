...
qq.FileUploader = function(o){
    this._options = {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-button">'+translate('uploadafile')+'</div>' +
        ...
        fileTemplate: '<li>' +
                ...
                '<a class="qq-upload-cancel" href="#">'+translate('cancel')+'</a>' +
                '<span class="qq-upload-failed-text">'+translate('faild')+'</span>' +
            '</li>',
...
qq.FileUploader.prototype = {
	...
	setAction: function(action){
       // alert(action);
		this._handler.setAction(action);
    },
    /**
    ...
    _uploadFile: function(fileContainer){            
        ...
        this._options.onSubmit(id, name,this);        
...
qq.UploadHandlerForm.prototype = {
    ...
    _createForm: function(iframe, params){
		...
		//alert(this._options.action + queryString);

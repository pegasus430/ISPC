...
(function($) {
	...
	$.fn.livesearchRemedyAid = function(options) {
		
		var defaults = {
				//livesearch.js settings
				livesearch_url		: 'ajax/aid',
				livesearch_id		: "livesearch_RemedyAid",
		...
		_opts.callBackRowReset =  function (_target) {
			...
			$('input[name*="\[remedy_id\]"]', _inputsOwner ).val('');
		...
		_opts.callBackRowClicked =  function(_target) {
			...
			//$('input[name*="\[rem_id_\]"]', _inputsOwner ).val($('input[id^="rem_id_"]', _clickedTR).val());
			
			$('input[name*="\[remedies\]"]', _inputsOwner ).val($('input[id^="rem_de_"]', _clickedTR).val());

			/* hidden */

			$('input[name*="\[remedy_id\]"]', _inputsOwner ).val($('input[id^="rem_id_"]', _clickedTR).val());
		...
		_opts.init = function(options) {		
			//overwrite
			window.selectRemedies = function (){

...
(function($) {
	...
	$.fn.livesearchSupplies = function(options) {
		
		var defaults = {
				//livesearch.js settings
				livesearch_url		: 'ajax/supplies',
				livesearch_id		: "livesearch_supplies",
		...
		_opts.callBackRowReset =  function (_target) {
			...
			$('input[name*="\[supplier_id\]"]', _inputsOwner ).val('');
		};

				...
				var rid_array = rid.split('-'); //2 strings (1 is type second is entity id
					...
					$.ajax({
						...
						success: function(response){
							$('#doctorletter_address').val(response.address);
							if(response.fax){
...
//	});
	...
	tinyMCE.init({
		...
		mode : "exact",
		language : "de",
		elements : "content, content1, content2, content3, content4, content5, content6, footer_textarea",
		theme : "advanced",
		relative_urls : false,
		absolute_urls : true,
...
//	tinymce.init({
//		selector: "textarea#content, textarea#content1, textarea#content2, textarea#content3, textarea#content4, textarea#content5, textarea#content6",
//		language: "de",
//		theme: "modern",
//		width: 655,
//		height: 450,
//		content_css: res_file_path+"/css/style.css",
//		plugins: [
//			"advlist lists charmap anchor pagebreak spellchecker",
...
//		
//		menubar: false,
//		toolbar: "bold italic underline strike strikethrough numlist | outdent indent blockquote | undo redo | alignleft aligncenter alignright alignjustify | forecolor code"
//	});
...
function getcourseinfo(par)
{
	ajaxCallserver({url:'patient/doctorlettercourse?shrt='+par.name+'&id='+request_id});
}
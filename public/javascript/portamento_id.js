...
(function($){
	...
	$.fn.portamento = function(options) {
		...
		panel.wrap('<div id="'+opts.port_id+'" />');
		var float_container = $('#'+opts.port_id);
		float_container.css({
...
//		RWH
		...
		thisWindow.resize(function() {
		    //if browser window is resized trigger portamento resize and reset container width
		    thisWindow.trigger('resize.portamento');

...
(function () {
    var inserttutorial = (function () {
        ...
        tinymce.PluginManager.add("inserttutorial", function (editor, url) {
            ...
            editor.ui.registry.addButton('inserttutorial', {
                text: "Insert tutorial",
                icon: 'bubbles',
                onAction: _onAction
            });

            // Define the Menu Item
            editor.ui.registry.addMenuItem('inserttutorial', {

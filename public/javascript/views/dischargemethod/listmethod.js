...
var delurl = appbase + 'dischargemethod/deletemethod?id=';
var ajaxurl = appbase + 'dischargemethod/listmethod';
...
$(document).ready(function() { /*------ Start $(document).ready --------------------*/
	...
	var delentatt = translate('youcannotdeletethismethodbecauseitsused');
...
//		},
		...
		columns: [
		          { data: "abbr", className: "","width": "10%"},
		          { data: "description", className: "","width": "50%"},

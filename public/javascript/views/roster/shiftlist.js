...
var delurl = appbase + 'roster/delete?id=';
var ajaxurl = appbase + 'roster/shiftlist';
...
//		},
		...
		columns: [
		          { data: "name", className: "","width": "40%"},
		          { data: "start", className: "","width": "10%"},
		          { data: "end", className: "","width": "10%"},

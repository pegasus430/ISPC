...
var delurl = appbase + 'medication/medicationssetslist?action=delete&id=';
var ajaxurl = appbase + 'medication/medicationssetslist';
...
//		},
		...
		columns: [
		          { data: "title", className: "","width": "65%"}, //ISPC-2554
		          { data: "entries", className: "","width": "20%"}, //ISPC-2554
		          { data: "actions", className: " ","width": "15%" } //ISPC-2554
			],

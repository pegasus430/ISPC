...
$(document).ready(function() {
	...
	$.getmedicationblocks = function(_obj) {

		var medication_type = _obj.medication_block_type;
		var drugplan_id = _obj.id;
		
		var url = appbase + 'patientmedication/editblocks?id=' + idpd +'&efaoption=1&drugplan_id='+drugplan_id+'&medication_type='+medication_type;
		...
		xhr = $.ajax({
			...
			success : function(response) {
				...
				medicationeditblocks_ready(false);

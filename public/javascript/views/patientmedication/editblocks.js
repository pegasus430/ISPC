...
//			 $(this).closest('tr').next().find('.cumulativ').find('b').text(parseFloat(totalss).toFixed(3));
			 ...
			 $(this).closest('tr').next().find('.selector_dsp_text').text(unit);		//ISPC-2664 Lore 21.10.2020
...
$('.expand_details').live('click',function(e){
	...
	if( $('.medication_row_'+med_id).hasClass('expanded')){
		...
		if(allow_medication_comunication_ii == '1') //added by Carmen 06.05.2020 for ISPC-2507
		{
			$twin		= jQuery('<div />').css({
				'position'		: 'absolute',
				'display'		: 'none',
...
$('.offline_ack_expand_details').live('click',function(){
	...
	function create_new_sh_line(medication_type,medcount,pumpe_number, pumpe_type)
	{
		...
		med_hidd +='<input type="hidden" name="medication_block['+medication_type+']['+pumpe_number+']['+medcount+'][is_btm]" class="medication_is_btm" id="'+medication_type+'_medication_is_btm-'+pumpe_number+'_'+medcount+'"  value="" >';//ISPC-2912,Elena,25.05.2021
...
//		var einheit_text = "EINHEIT"
		...
		if (show_dosage_unit == "1") {
			...
			var med_concentration_label ='<input type="text" readonly style="width: 36%; background:transparent;border: none;"  value="'+einheit_text+' pro ml"  id="lbl_concentration_sh_'+medication_type+'_'+pumpe_number+'_'+medcount+'"  />';
		}else{
			var med_concentration_input ='<input type="text" placeholder="'+einheit_text+' pro ml" name="medication_block['+medication_type+']['+pumpe_number+'][concentration]['+medcount+']" value=""  data-ec_field="concentration"    data-medication_type="'+medication_type+'" class="xsmall_input medication_concentration sch_referral change_status extra_calculation"  id="concentration_sh_'+medication_type+'_'+pumpe_number+'_'+medcount+'"  data-pumpe_med="'+medcount+'"   data-pumpe_number="'+pumpe_number+'" title="'+medication_type+'_'+pumpe_number+'_'+medcount+'"  rel="'+medication_type+'"/>';
		}
		...
		if (show_dosage_unit == "1") {
			var med_simple_dosage_input ='<input type="text" placeholder="' + translate("medication_dosage_h") + '"  style="width: 74%;" name="medication_block['+medication_type+']['+pumpe_number+'][dosage]['+medcount+']"  value="" data-ec_field="dosage"   data-medication_type="'+medication_type+'"  class="dosage_input sch_referral change_status calculate_sh_d24h extra_calculation ph_dosage doseirung"   data-pumpe_med="'+medcount+'"  data-pumpe_number="'+pumpe_number+'" title="'+medication_type+'_'+pumpe_number+'_'+medcount+'"  data-row_info="'+medication_type+'_'+pumpe_number+'_'+medcount+'"    rel="'+medication_type+'"    id="dosage_sh_'+medication_type+'_'+pumpe_number+'_'+medcount+'"  />';
			var med_simple_dosage_label ='<input type="text" readonly style="width: 24%; background:transparent;border: none;"  value="ml/h"  id="lbl_dosage_sh_<?php echo $medication_type; ?>_<?php echo $pumpe_cnt;?>_<?php echo $cnt;?>"  />';
			var med_simple_dosage24h_input ='<input type="text"  placeholder="' + translate("medication_dosage24h") + '" style="width: 74%;" name="medication_block['+medication_type+']['+pumpe_number+'][dosage_24h]['+medcount+']"  value="" data-ec_field="dosage_24h"  data-medication_type="'+medication_type+'"  class="dosage_input medication_dosage24_numeric sch_referral change_status  calculate_sh_d extra_calculation ph_dosage_24h doseirung"   data-pumpe_med="'+medcount+'" data-pumpe_number="'+pumpe_number+'" title="'+medication_type+'_'+pumpe_number+'_'+medcount+'"   data-row_info="'+medication_type+'_'+pumpe_number+'_'+medcount+'"    rel="'+medication_type+'"   id="dosage_sh_24h_'+medication_type+'_'+pumpe_number+'_'+medcount+'"    />';
			var med_simple_dosage24h_label ='<input type="text" readonly style="width: 24%; background:transparent;border: none;"  value="ml/24h"  id="lbl_dosage_sh_24h_<?php echo $medication_type; ?>_<?php echo $pumpe_cnt;?>_<?php echo $cnt;?>"  />';
		}
		var med_simple_dosage_unit_input ='<input type="text" placeholder="' + translate("medication_dosage_h_unit") + '"  style="width: 74%;" name="medication_block['+medication_type+']['+pumpe_number+'][unit_dosage]['+medcount+']"  value="" data-ec_field="unit_dosage"   data-medication_type="'+medication_type+'"  class="unit_dosage sch_referral change_status extra_calculation"   data-pumpe_med="'+medcount+'"  data-pumpe_number="'+pumpe_number+'" title="'+medication_type+'_'+pumpe_number+'_'+medcount+'"  data-row_info="'+medication_type+'_'+pumpe_number+'_'+medcount+'"    rel="'+medication_type+'"    id="dosage_sh_unit_'+medication_type+'_'+pumpe_number+'_'+medcount+'"  />';
		var med_unit_dosage_label ='<input type="text" readonly placeholder="' + translate("medication_dosage_h_unit") + '"  style="width: 24%; background:transparent;border: none;"  value="'+einheit_text+'/h"  id="lbl_dosage_sh_unit_'+medication_type+'_'+pumpe_number+'_'+medcount+'"  />';
		var med_simple_dosage24h_unit_input ='<input type="text"  placeholder="' + translate("medication_dosage_24h_unit") + '" style="width: 74%;" name="medication_block['+medication_type+']['+pumpe_number+'][unit_dosage_24h]['+medcount+']"  value="" data-ec_field="unit_dosage_24h"  data-medication_type="'+medication_type+'"  class="unit_dosage_24h sch_referral change_status extra_calculation"   data-pumpe_med="'+medcount+'" data-pumpe_number="'+pumpe_number+'" title="'+medication_type+'_'+pumpe_number+'_'+medcount+'"   data-row_info="'+medication_type+'_'+pumpe_number+'_'+medcount+'"    rel="'+medication_type+'"   id="dosage_sh_24h_unit_'+medication_type+'_'+pumpe_number+'_'+medcount+'"    />';
		var med_unit_dosage24h_label ='<input type="text" readonly placeholder="' + translate("medication_dosage_h_unit") + '"  style="width: 24%; background:transparent;border: none;"  value="'+einheit_text+'/24h"  id="lbl_dosage_sh_24h_unit_'+medication_type+'_'+pumpe_number+'_'+medcount+'"  />';
...
//		sch_pump_block +='<tr class="single"><td><label>' + translate("ispumpe_next_bolus") + '</label></td><td><input type="text" class="small_input ispumpe_calculation" name="medication_block[ispumpe]['+pumpecount+'][ispumpe_pumpe][next_bolus]" data-ec_field="next_bolus" data-ispumpe_pumpe_number="'+pumpecount+'"   id="next_bolus_ispumpe_'+pumpecount+'"   value=""  /></td></tr>';
	...
	function create_new_ispumpe_line(medication_type,medcount,ispumpe_pumpe_number, pumpe_type)
	{
		...
		med_hidd +='<input type="hidden" name="medication_block['+medication_type+']['+ispumpe_pumpe_number+']['+medcount+'][is_btm]" class="medication_is_btm" id="'+medication_type+'_medication_is_btm-'+ispumpe_pumpe_number+'_'+medcount+'"  value="" >';//ISPC-2912,Elena,25.05.2021
...
/*		var dosaje_str = "";
		...
		med_hidd +='<input type="hidden" name="medication_block['+medication_type+']['+medcount+'][is_btm]" class="medication_is_btm" id="'+medication_type+'_medication_is_btm-'+medcount+'"  value="" >'; //ISPC-2912,Elena,25.05.2021
		...
		else if(medication_type == "treatment_care")
		{
			...
			//TODO-3434 Ancuta 18.09.2020 - erro 
			var med_comment_input ='<input name="medication_block['+medication_type+'][comments]['+medcount+']"  placeholder='+ translate("medication_comments") +'  data-medication_type="'+medication_type+'" class="referral  change_status xxl_input editcomment" title="'+medication_type+'_'+medcount+'" rel="'+medication_type+'" style="background:#fff;" />';
		}
		else
		{
			var med_comment_label ='';
...
//		var med_toggle_child ='<td class="details delete_new_row" onClick="medi_child_toggle(\'#tr'+medication_type+medcount+'\')"  data-medication_type="'+medication_type+'" rel="'+medcount+'" ></td>';
		...
		var med_has_interval_q = '<li style="width: 420px; "><div class="interval_question"><label><input type="checkbox" value="1"  name="medication_block['+medication_type+'][has_interval]['+medcount+']"  data-medication_type="'+medication_type+'"  data-medcount="'+medcount+'"  id="has_interval_'+medication_type+'_'+medcount+'"  /> ' + translate("is interval medi?") + '</label></div></li>'
		...
		if(!module_pediatric_medication){
					...
					if((medication_type == "actual" || medication_type == "isivmed") && allow_normal_scheduled == "1") {
						...
						child_row += '<ul class="item">' 
							...
							+ med_has_plan_q
							+ med_has_plan_start
							+ med_future_plan_date_label
							+ med_future_plan_date_input
							+ med_has_plan_end 
							+ '</ul>';
					} 
				...
				if(new_fields == "1"){
					...
					if($.inArray( medication_type, timed_bocks_arr ) >= 0){
						...
						//+'kumulativ:&nbsp;<font style="font-weight: bold;"><span></span></font>&nbsp;absolut.bzw&nbsp;<font style="font-weight: bold;"><b></b>&nbsp;pro&nbsp;kg</font>/Körpergewicht&nbsp;über&nbsp;<font style="font-weight: bold;">24 Stunden</font>'						+'</td>'
...
//				full_tr +=td_start+med_has_interval_q+med_has_interval_start+med_days_interval_label+med_days_interval_input+med_administration_date_label+med_administration_date_input+med_has_interval_end+td_end;
	...
	function selectMedications(mid, row, mmi_handler)   
	{
		...
		else
		{
			...
			var is_btm = $('#medi_ISBTM_'+mid , table_search_results).val() || 0; //ISPC-2912,Elena,25.05.2021
			...
			if(pumpe_number)
			{
				...
				$('input.medication_is_btm' , parent_tr).val(is_btm);//ISPC-2912,Elena,25.05.2021
			    //TODO-3365 Carmen 21.08.2020
			...
			else
			{
			    ...
			    if(js_pharmaindex_settings.atc == 'yes')
				{
			    	$('input.medication_atc' , parent_tr).val(atc); //ISPC-2554 pct.3 Carmen 26.03.2020
				}
			    else
			    {
			    	$('input.medication_atc' , parent_tr).val(''); //ISPC-2554 pct.3 Carmen 26.03.2020
			    }
			    //TODO-3365 Carmen 21.08.2020
	...
	function remove_medication(mid,pid,trid,medication_type)
	{
		if(mid>0)
		{
			/*
		...
		if(acknowledge == "1"){
			...
			else
			{
				...
				if (efaoption == 1 ) {
					...
					dataObj = {};
					dataObj.id = mid;
					dataObj.medication_block_type = medication_type;
					
					$.getmedicationblocks(dataObj);	
				} else {
					$.getmedicationblocks();
				}
			}
...
//	ISPC-2829 Ancuta 18.03.2021 - added show deleted param
	var medicationeditblocks_ready = function(show_deleted) {
	//$(document).ready(function(){
 	if(show_deleted === undefined) {
	      show_deleted = true;
	}
			...
			$('.extra_calculation').live("change keyup",function(eventObject){
				...
				if(field == "concentration"  )
				{
					...
					if(flussrate && isNumeric(flussrate) && isNumeric(concentration)  && concentration != ""  && flussrate != ""){ // calculate dosage
						...
						if(has_comma != "-1"){
							//TODO-3624 Ancuta 23.11.2020 - changed decimal from 2 to 3
  		...
  		if (show_mmi == "1") {
			...
			*/		
			...
			pi.callback = function(recipe, drug, extra_object ){	
				...
				var pzn = 0;
				var is_btm = 0;//ISPC-2912,Elena,25.05.2021
				var source = "custom";
				var dbf_id = 0;
				...
				if (arguments.length == 3 && typeof arguments[2] == 'object') {
					...
					if (arguments[2]['source'] == "mmi_dialog_price" && typeof arguments[2]['PRICE_ITEM'] == 'object') {
						...
						*/
						...
						var iconcode_list_array = PRODUCT['ICONCODE_LIST'];
						for(var i=0; i < iconcode_list_array.length; i++){
							if(iconcode_list_array[i] == 'BTM'){
								is_btm = 1;
							}
						}
	            ...
	            if (parent_tr = $(active_recipe_row).closest("tr")) {
					...
					//ISPC-2912,Elena,25.05.2021
					$('.medication_is_btm', parent_tr).val(is_btm.toString().escapeValue());
	    	   	     //TODO-3365 Carmen 21.08.2020
	 			    if(js_pharmaindex_settings.atc == 'yes')
	 				{
				    ...
				    if(js_pharmaindex_settings.takinghint == 'yes')
					{
	    	   	     /*if(module_takinghint == '1')
	    	   	     {*/
	    	   	    	 $('.editcomment', parent_tr).val(takinghint); //ISPC-2554 pct.3 Carmen 16.06.2020
	    	   	     //}
					}
				    else
				    {
				    	$('.editcomment', parent_tr).val(''); //ISPC-2554 pct.3 Carmen 16.06.2020
				    }
				    //--
			...
			$('.livesearchmedinp').live('change', function() {
				...
				if(medication_type == "isschmerzpumpe"){
					...
					reset_medications(medication_type,input_row,pump_nr);
				} else {
					reset_medications(medication_type,input_row);
				}
				//
...
//						var dosage_concentration_full = dosage_concentration;//TODO-3624 Ancuta 23.11.2020 								
...
//						$('#dosage_concentration_full_' + column_info).val(dosage_concentration_full);	//TODO-3624 Ancuta 23.11.2020 
					} else{

						$('#dosage_concentration_' + column_info).val('');
//						$('#dosage_concentration_full_' + column_info).val('');//TODO-3624 Ancuta 23.11.2020 
					}
				}
				else
				{
...
//							var dosage_full = dosage_concentration * concentration;//TODO-3624 Ancuta 23.11.2020 
...
//							$('#dosage_full_' + column_info).val(dosage_full);//TODO-3624 Ancuta 23.11.2020 
							
						} else{
							$('#dosage_' + column_info).val('');
//							$('#dosage_full_' + column_info).val('');//TODO-3624 Ancuta 23.11.2020 
						}
					}
					else
					{
...
// 			console.log(this);
			remove_medication(drug_id,pid,trid,medication_type);
		});

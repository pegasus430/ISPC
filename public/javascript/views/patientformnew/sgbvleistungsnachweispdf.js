...
//console.log("sgbvleistungsnachweispdf");
...
$(document).ready(function() {
	...
	$( "table#data_table" ).on( "dblclick", "td", function() {
		var _this = $(this);
...
function selected_month_change()
{
	...
	window.location.href= appbase + 'patientformnew/sgbvleistungsnachweispdf?id=' +  idpd + "&selected_month=" + selected_month;
}
...
//				$("textarea.user_defined_days", $('#add_action_dialog')).val(checked_options.join(', '));
		...
		{
			text: translate('sgbvleistungsnachweispdf_lang')['remove_action'],
			click: function() {
	...
	.dialog({
		...
		width:'500',
		height:'430',
		title: translate('sgbvleistungsnachweispdf_lang')['add_action_dialog_title'],
...
function add_action_line(_this_icon , _this_dialog)
{
	...
	var add_action_actions_text =  $(".add_action_actions option:selected", _this_dialog).text();// + "<br/>" + translate('sgbxileistungsnachweispdf_lang')['interval_'+add_action_interval];
...
function add_hour_dialog(_this)
{
	$('#add_hour_dialog').dialog({
		autoOpen: true,
		modal: true,
		title: translate('sgbvleistungsnachweispdf_lang')['add_hour_title'],
		buttons: [
		          {
...
function remove_groupid_dialog( _this)
{
	$('#remove_groupid_dialog').dialog({
		autoOpen: true,
		modal: true,
		title: translate('sgbvleistungsnachweispdf_lang')['remove_groupid_dialog_title'],
		buttons: [
		          {

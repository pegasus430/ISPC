...
function add_new_wallnews(_that) {
	...
	$('<div>').append($("#overviewcolumn_content_item21 #box_21_dialog form").clone())
	.appendTo('body')	
    .dialog({
        'autoOpen'  : true,
        'modal'     : true,
        ...
        'open'      : function (){
            if (typeof(_that) === 'object') {
                ...
                $(this).find("select[name*='\[patient\]']").val(_data.patient_id);
                     ...
                     click: function(){
                            ...
                            $.post(_url, _data, function(result) {
                                ...
                                if (result.hasOwnProperty('success') && result.success == true && typeof(overviewcolumn_content_item21_datatable) == 'object') {                                    
                                    ...
                                    var _patient_nice_name = $("#overviewcolumn_content_item21 #box_21_dialog select option[value='"+_data.wallNews.patient+"']").text() || '';
...
function drawDataTableWallNews() {
    ...
    return $('#overviewcolumn_content_item21 #box_21_table').dataTable({
         "language": {

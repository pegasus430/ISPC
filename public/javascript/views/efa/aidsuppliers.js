...
var url = appbase + 'efa/aidsuppliers?id='+idpd+'&step=show_aids';
xhr = $.ajax({
	url : url,
...
//
  ...
  uploader_create(
    		"qq_file_uploader_placeholder_nf", 
  ...
  uploader_create(
    		"qq_file_uploader_placeholder_ff", 
    		['*', 'pdf', 'docx', 'doc', 'xml', 'xls', 'csv'],
    		null,
    		true
    		);	
 
	$("#tabs_files_suppliers").tabs({
		...
		show : function(event, ui) {
			...
			switch (ui.index) {
				...
				case 0:
					window.selectedTab = "show_aids";
				break;
				
				case 1:
					window.selectedTab = "nursing_files";
				break;
				
				case 2:
					window.selectedTab = "show_suppliers";
				break;
				
				case 3:
					window.selectedTab = "form_files";
				break;
	...
	$("#tabs_files_suppliers").tabs({
		...
		show : function(event, ui) {
			...
			case 1:
				url_selected_tab= "nursing_files";
				
			break;
			
			
			case 2:
				url_selected_tab= "show_suppliers";
				
				var dlist = '<div class="loadingdiv" align="center" style="width: 100%;float: left;"><img src="'+res_path +'/images/pageloading.gif"><br />	Loading... please wait</div>';
				$('.show_suppliers').html(dlist );
		
				var url = appbase + 'efa/aidsuppliers?id='+idpd+'&step=show_suppliers';
				xhr = $.ajax({
					url : url,
					success : function(response) {
						$('.show_suppliers').html(response);
					}
				});
			break;
			
			case 3:
				url_selected_tab= "form_files";
				
//				var dlist = '<div class="loadingdiv" align="center" style="width: 100%;float: left;"><img src="'+res_path +'/images/pageloading.gif"><br />	Loading... please wait</div>';
//				$('.form_files').html(dlist );
//		
//				var url = appbase + 'efa/aidsuppliers?id='+idpd+'&step=form_files';
//				xhr = $.ajax({
//					url : url,
//					success : function(response) {
//						$('.form_files').html(response);
//					}
//				});
			break;

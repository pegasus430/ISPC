...
function SwampyBrowser(dir, file)
{
		...
		for(var i=0; i < files.length; i++)
		{
			...
			switch(fType)
			{
				...
				case "dir":
					...
					break;
				case "file":
					cell.ondblclick = new Function("browser.insertFile('swampy_browser/gallery/"+file+"');");
					cell.onclick = new Function("browser.selectFile('swampy_browser/gallery/"+file+"','"+fName+"','"+extension+"','"+size+"','', this);");
					optDiv += "\t<a href=\"javascript:browser.insertFile('swampy_browser/gallery/"+file+"');\">"+Lang.opt_insert+"</a>\n";
					break;
				case "image":
					
					cell.ondblclick = new Function("browser.insertImage('swampy_browser/gallery/"+file+"');");
					cell.onclick = new Function("browser.selectFile('swampy_browser/gallery/"+file+"','"+fName+"','"+extension+"','"+size+"','"+dim+"', this);");
					optDiv += "\t<a href=\"javascript:browser.insertImage('swampy_browser/gallery/"+file+"');\">"+Lang.opt_insert+"</a>\n";
	...
	this.insertFile = function(file)
	{
		...
		//alert(file);
		window.opener.insertURL(baselocation+"admins/"+file);
		top.window.close();
	}

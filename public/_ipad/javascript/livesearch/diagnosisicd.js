...
function diagnosisIcdDropDown(did)
{
 ...
 if(ltrval)
 {
   ...
   ajaxCallserver({url:'diagnosis/fetchdropdown',
				  ...
				  method:'POST',
				  data:{ltr:ltrval,did:did,tb:tabname,srch:'icdnumber'}
				  });
 }
 else
 {
...
//	$('#course_title'+did).val(text);
	...
	var t = setTimeout(function(){$('#icdnumber'+did).trigger('blur');},15);
}
 ...
 var icdlivesearchkeup =   function( e,ele ){
		...
		setTimeout(function(){diagnosisIcdDropDown(id)},100);

	...
	if($('#meta_'+aid).hasClass("hideMeta"))
		{
				...
				$('#meta_'+aid).show();
				 $("#AddImg"+aid).attr("src","_ipad/images/action_minus.png");
		...
		else
		{
			if($("#meta_title_"+aid+"_0").val()==0 && $("#meta_title_"+aid+"_0").val()==0 && $("#meta_title_"+aid+"_0").val()==0)
			{
				...
				$('#meta_'+aid).hide();
				 $("#AddImg"+aid).attr("src","_ipad/images/action_add.png");
...
function selectDiagnosis2(i,did)
{
  ...
  function admission_selectdignosis()
  {
	 ...
	 for(var i=0;i<jarr.length;i++)
	 {
		 ...
		 radiostr += '<td><input type="radio" name="dtype['+cns+']" id="dtype'+cns+'" value="'+jarr[i].id+'"  style="height: 25px; width: 25px;"></td>';
	 }
	 ...
	 var trInnerHtml = $('<tr id="stab'+cns+'"><td valign="top" id="listadmissiondiagnosistd_i'+cns+'"><input name="icdnumber['+cns+']" id="icdnumber'+cns+'" value="" class="livesearchicdinp diagicd" type="text"  size="10" /><div id="icddiagnodropdown'+cns+'" style="position: absolute; display:none;" class="medicationDiagnDrp icdlivesearchdropdown"></div></td><td valign="top" id="listadmissiondiagnosistd_d'+cns+'"><input name="diagnosis['+cns+']" id="diagnosis'+cns+'" value="" size="33" class="livesearchinp diagdesc" type="text" /><input name="hidd_icdnumber['+cns+']" value="" id="hidd_icdnumber'+cns+'" type="hidden"><input name="hidd_diagnosis['+cns+']" value="" id="hidd_diagnosis'+cns+'" type="hidden"><input type="hidden" id="hidd_tab'+cns+'" name="hidd_tab['+cns+']" value="" /><div id="diagnodropdown'+cns+'" style="position: absolute; display:none;" class="medicationDiagnDrp livesearchdropdown"></div></td>'+radiostr+'<td class="" valign="middle" align="center"><a class="AddButton" id="addm_'+cns+'"><img src="_ipad/images/action_add.png" border="0" id="AddImg'+cns+'"></a></td><td  valign="middle" align="center"><a href="javascript:void(0)" onclick="removeElements(\'#stab'+cns+'\',\'#meta_'+cns+'\')"><img src="_ipad/images/action_delete.png" border="0" /></a></td></tr><tr id="meta_'+cns+'" style="display:none" class="hideMeta"><td>&nbsp;</td><td colspan="5"><table ><tr><td ><label class="forlabel">Metastasierung</label>'+dignometa1+'</td></tr><tr><td ><label class="forlabel">Metastasierung</label>'+dignometa2+'</td></tr><tr><td ><label class="forlabel">Metastasierung</label>'+dignometa3+'</td></tr></table></td></tr>');
  ...
  function selectdignosis()
  {
	 ...
	 for(var i=0;i<jarr.length;i++)
	 {
		 ...
		 radiostr += '<td><input type="radio" name="dtype['+cnt+']" id="dtype'+cnt+'" value="'+jarr[i].id+'" style="height: 25px; width: 25px;"></td>';
	 }
	 ...
	 var trInnerHtml = $('<tr id="stab'+cnt+'"><td valign="top" id="listadmissiondiagnosistd_i'+cnt+'"><input name="icdnumber['+cnt+']" id="icdnumber'+cnt+'" value="" class="livesearchicdinp diagicd" type="text" size="10" /><div id="icddiagnodropdown'+cnt+'" class="icdlivesearchdropdown" style="position: absolute; display:none;"></div></td><td valign="top" id="listadmissiondiagnosistd_d'+cnt+'"><input name="diagnosis['+cnt+']" id="diagnosis'+cnt+'" value="" size="33" class="livesearchinp diagdesc" type="text" /><input name="hidd_icdnumber['+cnt+']" value="" id="hidd_icdnumber'+cnt+'" type="hidden"><input name="hidd_diagnosis['+cnt+']" value="" id="hidd_diagnosis'+cnt+'" type="hidden"><input name="hidd_ids['+cnt+']" value="" id="hidd_ids'+cnt+'" type="hidden"><input name="hidd_tab['+cnt+']" value="" id="hidd_tab'+cnt+'" type="hidden"><div id="diagnodropdown'+cnt+'" class="samtablistDiognoDrp livesearchdropdown" style="position: absolute; display:none;"></div>'+radiostr+'</td><td valign="middle" align="center"><a class="AddButton" id="addm_'+cnt+'"><img src="_ipad/images/action_add.png" border="0" id="AddImg'+cnt+'"></a></td><td  valign="middle" align="center" id="listadmissiondiagnosisdeltd_d'+cnt+'"><a href="javascript:void(0)" onclick="removeElementsfromTab(\'#stab'+cnt+'\',\'#meta_'+cnt+'\',\'\')"><img src="_ipad/images/action_delete.png" border="0" /></a></td></tr><tr id="meta_'+cnt+'" style="display:none" class="hideMeta"><td>&nbsp;</td><td colspan="5"><table ><tr><td ><label class="forlabel">Metastasierung</label>'+dignometa1+'</td></tr><tr><td ><label class="forlabel">Metastasierung</label>'+dignometa2+'</td></tr><tr><td><label class="forlabel">Metastasierung</label>'+dignometa3+'</td></tr></table></td></tr>');
	...
	// ip3.onkeyup=function(){diagnosisDropDown(this.tempid);};
	 ...
	 cell3.innerHTML = '<a href="javascript:void(0)" onclick="removeElem(\'#stab'+cnt+'\')"><img src="_ipad/images/action_delete.png" border="0" /></a>';
	 cell5.innerHTML = '<a class="AddButton" id="addm_'+cnt+'"><img src="_ipad/images/action_add.png" border="0" id="AddImg'+cnt+'" /></a>'; 

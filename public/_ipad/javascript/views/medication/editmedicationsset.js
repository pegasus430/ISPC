...
/*				htmldiv += '<div style="width: 100%; float: left;">';
					htmldiv += '<img src="' + appbase + 'images/btttt_plus.png" class="add_dosage" data-row="'+setcount+'" width="32" height="32"">';
				htmldiv += '</div>';*/
			...
			htmldiv += '<div style="width: 14%; float: left; border-right: 1px solid #000; height: '+newsetheight+'px; padding-left: 5px; padding-top: 5px;">';
				...
				//Darreichungsform
				htmldiv += '<div style="width: 21%; float: left;">';
				...
				htmldiv += '</div>';
				htmldiv += '<div style="width: 70%; float: left;">';
			...
			htmldiv += '<div style="width: 3%; float: left; height: '+newsetheight+'px; padding-left: 5px; padding-top: 5px;">';
				htmldiv += '<div style="width: 100%; float: left;">';
					htmldiv += '<img src="' + appbase + 'images/btttt_minus.png" class="delrow" data-row="'+setcount+' width="32" height="32" >';
				htmldiv += '</div>';
			htmldiv += '</div>';
		htmldiv += '</div>';
		htmldiv += '<div style="clear: both;"></div>';
	...
	//$(".add_dosage").live("click", function() {
		...
		if(parseInt(textarearows)-(parseInt(doscount)+1) <= 8)
		{			
			newsetheight = parseInt(newsetheight)+35;

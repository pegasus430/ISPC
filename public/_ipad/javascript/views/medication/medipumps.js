...
var delurl = appbase + 'medication/deletemedipump?id=';
var ajaxurl = appbase + 'medication/medipumps';
...
//		},
		...
		columns: [
		          { data: "shortcut", className: "","width": "10%"},
		          { data: "medipump", className: "","width": "50%"},

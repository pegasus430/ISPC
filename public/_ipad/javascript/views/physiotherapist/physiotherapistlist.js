...
var delurl = appbase + 'physiotherapist/deletephysiotherapist?id=';
var ajaxurl =appbase + 'physiotherapist/physiotherapistlist';
...
//		},
		...
		columns: [
		          { data: "physiotherapist", className: "","width": "10%"},
		          ...
		          { data: "icon", className: "","width": "5%"},
		          { data: "actions", className: " ","width": "15%" }
			],

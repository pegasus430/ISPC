...
var delurl = appbase + 'servicesfuneral/deleteservices?id=';
var ajaxurl = appbase + 'servicesfuneral/servicesfunerallist';
...
//		},
		...
		columns: [
		          { data: "services_funeral_name", className: "","width": "20%"},
		          { data: "cp_fname", className: "","width": "10%"},
		          { data: "cp_lname", className: "","width": "10%"},
		          { data: "zip", className: "","width": "10%"},
		          { data: "city", className: "","width": "10%"},
		          { data: "phone", className: "","width": "10%"},

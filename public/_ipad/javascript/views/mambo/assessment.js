	...
	_inputs = $.map(_feedback_options.__meta, function (checked, val){
		...
		return "<div class='selector_feedback_options_option' data-type='"+val+"'>\
					...
					<span>"
						...
						+ "<textarea data-type='freetext' style='display:none' name='feedback_options[" + _feedback_options.__block_name + "][" + _feedback_options.__parent+"]["+_feedback_options.__fnName+"]["+ val +"_val][freetext]'>" + (_feedback_options.hasOwnProperty("__meta_val") && _feedback_options.__meta_val.hasOwnProperty(val) ? _feedback_options.__meta_val[val]['freetext'] : '' ) + "</textarea>"				
						+ "<input data-type='userstodo' type='hidden' name='feedback_options["+_feedback_options.__block_name+"]["+_feedback_options.__parent+"]["+_feedback_options.__fnName+"]["+ val +"_val][user]' value='" + (_feedback_options.hasOwnProperty("__meta_val") && _feedback_options.__meta_val.hasOwnProperty(val) ? _feedback_options.__meta_val[val]['user'] : '' ) + "' >"
						+ "<input data-type='date' type='hidden' name='feedback_options["+_feedback_options.__block_name+"]["+_feedback_options.__parent+"]["+_feedback_options.__fnName+"]["+ val +"_val][date]' value='" + (_feedback_options.hasOwnProperty("__meta_val") && _feedback_options.__meta_val.hasOwnProperty(val) ? _feedback_options.__meta_val[val]['date'] : '' ) + "' >"
...
function feedbackQtipOptionDialog(_that) //_that is the _optionRow
{
	...
	.dialog({
        ...
        open : function() {
			...
			$("input[data-type='date']", this).val($("input[data-type='date']", _that).val() || moment().format('D.MM.YYYY'));

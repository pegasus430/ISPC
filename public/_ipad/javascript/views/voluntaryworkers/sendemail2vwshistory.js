/* sendemail2vwshistory.js ipad */
	...
	function drawDatatable() {
		var email_datatable = $('#histoy_dtable').DataTable({
			// ADD language
			"language": {
...
//			        	  "width":"220px"
			          ...
			          
			          {
			        	  ...
			        	  title: translate('sendemail2vwshistory_lang')['no_of_recipients'] ,
			        	  "width":"220px"
			          },
			...
			"initComplete": function( settings, json ) {
				...
				var label_text = translate('sendemail2vwshistory_lang')['filter by member'];
			    ...
			    $('#histoy_dtable tbody').on('click', 'tr:not(.smalltable)', function () {
	...
	function format ( d ) {
		...
		var html =  '<table cellpadding="5" cellspacing="0" border="0" class="transparent" style="padding-left:50px;">'+
	        '<tr class="smalltable">'+
	            '<td width="130px">' + translate('sendemail2vwshistory_lang')['sent by'] + '</td>'+
	            '<td>' + d.email_sent_by + '</td>'+
	        '</tr>'+
	        '<tr class="smalltable">'+
	            '<td>' + translate('sendemail2vwshistory_lang')['email_content'] +'</td>'+
	            '<td>' + d.email_content + '</td>'+
	        '</tr>'+
	        '<tr class="smalltable">'+
	            '<td>' + translate('sendemail2vwshistory_lang')['sent to'] +'</td>'+
		...
		if (d.email_attachment_id != null) 
		{
            ...
            '<td>' + translate('sendemail2vwshistory_lang')['email_attachment'] +'</td>'+
			
            	
            '<td> <a href = "'+appbase+'voluntaryworkers/vwfile?doc_id='+ d.email_attachment_id +'&tab=voluntary_worker&is_image=0" >' + d.email_attachment_filename + '</a></td>'+
            '</tr>';
		}

...
var delurl = appbase + 'voluntaryworkers/secondarystatusesdelete?id=';
var ajaxurl = appbase + 'voluntaryworkers/secondarystatuseslist';

var left_menu_list; // this will be the datatable object

$(document).ready(function() { /*------ Start $(document).ready --------------------*/
	var confdel = translate('confirmdeleterecord');
	var confdelentatt = translate('confirmdeleterecordwithvoluntaryattached');

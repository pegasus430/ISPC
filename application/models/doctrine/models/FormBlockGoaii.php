<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('FormBlockGoaii', 'MDAT');

	class FormBlockGoaii extends BaseFormBlockGoaii {

		public function getPatientFormBlockGoaii($ipid, $contact_form_id, $allow_deleted = false)
		{
		...
		public function get_patients_form_block_goaii($ipids, $contact_form_ids, $only_checked = false, $allow_deleted = false)
		{
			if(!is_array($ipids))
			{

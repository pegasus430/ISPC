<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('BwInvoicePaymentsNew', 'SYSDAT');

	class BwInvoicePaymentsNew extends BaseBwInvoicePaymentsNew {

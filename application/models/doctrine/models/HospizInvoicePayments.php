<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('HospizInvoicePayments', 'SYSDAT');

	class HospizInvoicePayments extends BaseHospizInvoicePayments {

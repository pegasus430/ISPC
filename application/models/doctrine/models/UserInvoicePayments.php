<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('UserInvoicePayments', 'SYSDAT');

	class UserInvoicePayments extends BaseUserInvoicePayments {

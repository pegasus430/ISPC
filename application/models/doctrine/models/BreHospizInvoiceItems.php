<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('BreHospizInvoiceItems', 'SYSDAT');

	class BreHospizInvoiceItems extends BaseBreHospizInvoiceItems {

		public function getInvoicesItems($invoices)
		{
			$invoice_items = Doctrine_Query::create()
				->select('*')
				->from('BreHospizInvoiceItems')

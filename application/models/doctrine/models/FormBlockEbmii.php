<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('FormBlockEbmii', 'MDAT');

	class FormBlockEbmii extends BaseFormBlockEbmii {

		public function getPatientFormBlockEbmii($ipid, $contact_form_id, $allow_deleted = false)
		{

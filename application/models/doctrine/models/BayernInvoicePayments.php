<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('BayernInvoicePayments', 'SYSDAT');

	class BayernInvoicePayments extends BaseBayernInvoicePayments {

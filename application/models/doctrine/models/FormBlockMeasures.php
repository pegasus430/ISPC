<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('FormBlockMeasures', 'MDAT');

	class FormBlockMeasures extends BaseFormBlockMeasures {

		public function getPatientFormBlockMeasures($ipid, $contact_form_id, $allow_deleted = false)
		{
			$groups_sql = Doctrine_Query::create()
				->select('*')
				->from('FormBlockMeasures')
				->where("ipid='" . $ipid . "'")

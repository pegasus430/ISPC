<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('GroupDefaultVisibility', 'SYSDAT');

	class GroupDefaultVisibility extends BaseGroupDefaultVisibility {
		...
		public function getDefaultVisibilityByGroup($group_id)
		{
			$gp = Doctrine_Query::create()
				...
				->where('clientid = 0')
				->andWhere('master_group_id= ?', $group_id );
		...
		/**
		 * Loredana backup of fn getDefaultVisibilityAll
		 * ISPC-2482 Lore 22.11.2019
		 * @return unknown
		 * @deprecated
		 */
		public function getDefaultVisibilityAllold()
		{
			$gp = Doctrine_Query::create()
				->select('*')
				->from('GroupDefaultVisibility')
		...
		/**
		 * @author Loredana
		 * copy of fn getDefaultVisibilityAllold
		 * ISPC-2482 Lore 22.11.2019
		 * @return unknown
		 */
...
// 				->select('*')
         ...
         * 
         * ISPC-2482 Lore 22.11.2019
		 * copy of fn getClientVisibilityByGroup
		...
		/**
		 * Lore back of fn  getClientVisibilityAll
		 * ISPC-2482 Lore 22.11.2019
		 * @param unknown $clientid
		 * @return unknown
		 * @deprecated

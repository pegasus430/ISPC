<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('ShInternalInvoiceItems', 'SYSDAT');

	class ShInternalInvoiceItems extends BaseShInternalInvoiceItems {

		public function getInvoicesItems($invoices)
		{
			$invoice_items = Doctrine_Query::create()
				->select('*')
				->from('ShInternalInvoiceItems')

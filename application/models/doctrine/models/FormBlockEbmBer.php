<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('FormBlockEbmBer', 'MDAT');

	class FormBlockEbmBer extends BaseFormBlockEbmBer {

		public function getPatientFormBlockEbmBer($ipid, $contact_form_id, $allow_deleted = false)
		{
			$groups_sql = Doctrine_Query::create()
				->select('*')
				->from('FormBlockEbmBer')
				->where("ipid='" . $ipid . "'")
		...
		public function get_patients_form_block_ebm_ber($ipids, $contact_form_ids, $only_checked = false, $allow_deleted = false)
		{

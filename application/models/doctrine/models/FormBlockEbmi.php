<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('FormBlockEbmi', 'MDAT');

	class FormBlockEbmi extends BaseFormBlockEbmi {

		public function getPatientFormBlockEbmi($ipid, $contact_form_id, $allow_deleted = false)
		{
		...
		public function get_patients_form_block_ebmi($ipids, $contact_form_ids, $only_checked = false, $allow_deleted = false)
		{
			if(!is_array($ipids))
			{

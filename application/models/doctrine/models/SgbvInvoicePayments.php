<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('SgbvInvoicePayments', 'SYSDAT');

	class SgbvInvoicePayments extends BaseSgbvInvoicePayments {

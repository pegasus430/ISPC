 ...
 *
 */
class IntenseDiagnosisConnectionListener extends Doctrine_Record_Listener
{ 
    /**
     * Array of options
     *
            ...
            if (! empty($share_info['intense_connection'])) {
                ...
                foreach ($share_info['intense_connection'] as $con => $con_ionfo) {
                    ...
                    if (in_array($ComponentName, $IntenseConnectionsOptions)) {
                        ...
                        if ($ComponentName == 'PatientDiagnosis') {
                            $PatientDiagnosis = new PatientDiagnosis();
                            $PatientDiagnosis->clone_records($share_info['source'],$share_info['source_client'], $share_info['target'], $share_info['target_client']);
                        }

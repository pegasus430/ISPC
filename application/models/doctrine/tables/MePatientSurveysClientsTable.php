 ...
 */
class MePatientSurveysClientsTable extends Pms_Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return MePatientSurveysClientsTable (object)
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('MePatientSurveysClients');
    }
}
 ...
 */
class PatientTreatmentPlanTable extends Pms_Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return MamboAssessmentTable (object)
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('PatientTreatmentPlan');
    }

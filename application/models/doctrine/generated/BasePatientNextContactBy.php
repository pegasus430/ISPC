...
Doctrine_Manager::getInstance()->bindComponent('PatientNextContactBy', 'IDAT');

/**
 * BasePatientNextContactBy
 * 
 ...
 */
abstract class BasePatientNextContactBy extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patient_next_contact_by');

<?php
	...
	Doctrine_Manager::getInstance()->bindComponent('InternalInvoicesSpecificVisits', 'SYSDAT');

	abstract class BaseInternalInvoicesSpecificVisits extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('internal_invoices_specific_visits');
			...
			$this->hasColumn('visit_type', 'enum', null, array('type' => 'enum', 'notnull' => false, 'values' => array('kvno_nurse_form','kvno_doctor_form','visit_koordination_form','bayern_doctorvisit')));

<?php
	...
	abstract class BaseHiInvoices extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('hi_invoice');
			...
			$this->hasColumn('header', 'string', NULL, array('type' => 'string', 'length' => NULL));
			$this->hasColumn('footer', 'string', NULL, array('type' => 'string', 'length' => NULL));

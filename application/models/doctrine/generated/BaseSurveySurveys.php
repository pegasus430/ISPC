...
Doctrine_Manager::getInstance()->bindComponent('SurveySurveys', 'IDAT');
 ...
 */
abstract class BaseSurveySurveys extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('survey_surveys');
        ...
        $this->hasColumn('calc_type', 'string', 32, array(
            'type' => 'string',
            'length' => 32,
            'fixed' => false,
            'unsigned' => false,
    ...
    public function setUp()
    {
        ...
        $this->hasMany('SurveyQuestions', array(
            'local' => 'id',
            'foreign' => 'survey'
        ));
    }

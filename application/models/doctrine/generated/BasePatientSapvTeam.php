...
Doctrine_Manager::getInstance()->bindComponent('PatientSapvTeam', 'IDAT');


abstract class BasePatientSapvTeam extends Pms_Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('patient_sapv_team');
			$this->hasColumn('id', 'bigint', NULL, array('type' => 'bigint', 'length' => NULL, 'primary' => true, 'autoincrement' => true));
			$this->hasColumn('ipid', 'string', 255, array('type' => 'string', 'length' => 255));
			$this->hasColumn('name_sapv', 'string', 255, array('type' => 'string', 'length' => 255));

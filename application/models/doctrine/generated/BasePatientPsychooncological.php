...
Doctrine_Manager::getInstance()->bindComponent('PatientPsychooncological', 'IDAT');

/**
 * BasePatientPsychooncological
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property integer $id
 * @property string $ipid
 * @property enum $integrated
 * @property enum $necessity
 ...
 */
abstract class BasePatientPsychooncological extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patient_psychooncological');
        ...
        $this->hasColumn('integrated', 'enum', 18, array(
             'type' => 'enum',
             'length' => 18,
             'fixed' => false,
             'unsigned' => false,
             'values' => 
             array(
              0 => 'already_integrated',
              1 => 'not_yet_integrated',
             ),
             'primary' => false,
             'notnull' => false,
             'autoincrement' => false,

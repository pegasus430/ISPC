<?php
	...
	abstract class BaseMemberHistory extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('member_history');
			...
			$this->hasColumn('create_user', 'bigint', null, array('type' => 'bigint', 'length' => null));
				
			
			$this->hasColumn('id', 'bigint', NULL, array('type' => 'bigint', 'length' => NULL ));
...
// 			$this->hasColumn('mandate_reference', 'integer', 20, array('type' => 'integer', 'length' => 20));
			...
			$this->hasColumn('mandate_reference_date', 'date', NULL, array('type' => 'date', 'length' => NULL));
			// ISPC - 1518
		...
		function setUp()
		{
			$this->hasMany('MemberHistory', array(
					'local' => 'id',
					'foreign' => 'id'
			));

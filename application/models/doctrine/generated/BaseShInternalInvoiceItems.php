<?php
	...
	abstract class BaseShInternalInvoiceItems extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('sh_internal_invoice_items');
...
// 			$this->hasColumn('qty', 'int', 11, array('type' => 'integer', 'length' => 11));
			$this->hasColumn('qty', 'decimal', 10, array('scale' => 2));

...
Doctrine_Manager::getInstance()->bindComponent('PatientsOrdersDeliveryDatesHistory', 'MDAT');

/**
 * BasePatientsOrdersDeliveryDatesHistory
 * 
 ...
 */
abstract class BasePatientsOrdersDeliveryDatesHistory extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patients_orders_delivery_dates_history');

...
Doctrine_Manager::getInstance()->bindComponent('PatientWorkshopDisabledPeople', 'IDAT');


abstract class BasePatientWorkshopDisabledPeople extends Pms_Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('patient_workshop_disabled_people');

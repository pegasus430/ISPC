...
Doctrine_Manager::getInstance()->bindComponent('PatientsOrdersMaterials', 'MDAT');

/**
 * BasePatientsOrdersMaterials
 * 
 ...
 */
abstract class BasePatientsOrdersMaterials extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patients_orders_materials');

<?php
	...
	abstract class BaseHeInvoices extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('he_invoice');
			...
			$this->hasColumn('pricelist_type', 'string', 255, array('type' => 'string', 'length' => 255));

<?php
	...
	abstract class BaseBayernDoctorSymp extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('bayern_doctor_symptomatology');
			$this->hasColumn('id', 'integer', 8, array('type' => 'integer', 'length' => 8, 'primary' => true, 'autoincrement' => true));
			$this->hasColumn('ipid', 'string', 255, array('type' => 'string', 'length' => 255));
			$this->hasColumn('bdf_id', 'integer', 11, array('type' => 'integer', 'length' => 11));
		...
		function setUp()
		{
			...
			$this->hasOne('BayernDoctorVisit', array(
				'local' => 'bdf_id',
				'foreign' => 'id'
			));

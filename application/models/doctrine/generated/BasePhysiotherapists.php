<?php
	...
	abstract class BasePhysiotherapists extends Pms_Doctrine_Record {

		public $ipid = null;//ISPC-2045
		
		function setTableDefinition()
		{
			$this->setTableName('physiotherapist');
			...
			//--
			$this->hasColumn('physiotherapist', 'string', 255, array('type' => 'string', 'length' => 255));
		...
		function setUp()
		{
		     ...
		     */
		    /*
			$this->hasOne('PatientPhysiotherapists', array(
				'local' => 'id',
				'foreign' => 'physioid'
			));
			*/

<?php
	...
	abstract class BaseServicesfuneral extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('services_funeral');
			...
			//--
			$this->hasColumn('services_funeral_name', 'string', 255, array('type' => 'string', 'length' => 255));
			$this->hasColumn('cp_fname', 'string', 255, array('type' => 'string', 'length' => 255));
			$this->hasColumn('cp_lname', 'string', 255, array('type' => 'string', 'length' => 255));

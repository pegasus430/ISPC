<?php
	...
	abstract class BaseMemberFamilyHistory extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('member_family_history');
...
// 			$this->hasColumn('mandate_reference', 'integer', 20, array('type' => 'integer', 'length' => 20));
			...
			$this->hasColumn('member_id', 'bigint', NULL);
		...
		function setUp()
		{
			$this->hasMany('MemberFamilyHistory', array(
					'local' => 'id',
					'foreign' => 'id'
			));

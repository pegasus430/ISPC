<?php
	...
	abstract class BaseSgbxiInvoices extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('sgbxi_invoice');
			...
			$this->hasColumn('start_sgbxi', 'datetime', NULL, array('type' => 'datetime', 'length' => NULL));
			$this->hasColumn('end_sgbxi', 'datetime', NULL, array('type' => 'datetime', 'length' => NULL));
			$this->hasColumn('ipid', 'string', 255, array('type' => 'string', 'length' => 255));
			$this->hasColumn('client', 'int', 11, array('type' => 'bigint', 'length' => 11));
			$this->hasColumn('contact_form_id', 'int', 11, array('type' => 'bigint', 'length' => 11));
			...
			$this->hasColumn('care_level', 'string', 12, array('type' => 'string', 'length' => 12));

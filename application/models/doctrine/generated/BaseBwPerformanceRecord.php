<?php
	...
	abstract class BaseBwPerformanceRecord extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('bw_performance_record');
			...
			$this->hasColumn('pay_days', 'integer', 1, array('type' => 'integer', 'length' => 1));
			$this->hasColumn('pay_date', 'datetime', 255, array('type' => 'varchar', 'length' => 255));

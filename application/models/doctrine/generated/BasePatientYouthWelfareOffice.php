...
Doctrine_Manager::getInstance()->bindComponent('PatientYouthWelfareOffice', 'IDAT');


	abstract class BasePatientYouthWelfareOffice extends Pms_Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('patient_youth_welfare_office');
			$this->hasColumn('id', 'bigint', NULL, array('type' => 'bigint', 'length' => NULL, 'primary' => true, 'autoincrement' => true));
			$this->hasColumn('ipid', 'string', 255, array('type' => 'string', 'length' => 255));
			$this->hasColumn('name_of_youth_welfare_office', 'string', 255, array('type' => 'string', 'length' => 255));
			$this->hasColumn('department_of_youth_welfare_office', 'string', 255, array('type' => 'string', 'length' => 255));

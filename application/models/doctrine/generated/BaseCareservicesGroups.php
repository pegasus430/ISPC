<?php
	...
	abstract class BaseCareservicesGroups extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('care_services_groups');
			$this->hasColumn('id', 'integer', 11, array('type' => 'integer', 'length' => 11, 'primary' => true, 'autoincrement' => true));
			$this->hasColumn('groupname', 'string', 255, array('type' => 'integer', 'length' => 255));

...
abstract class BaseOrderAdmission extends Pms_Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('orderadmission');
			...
			//--
			$this->hasColumn('orderer', 'text', NULL, array('type' => 'text', 'length' => NULL));

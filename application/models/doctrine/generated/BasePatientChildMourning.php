...
Doctrine_Manager::getInstance()->bindComponent('PatientChildMourning', 'IDAT');

/**
 * BasePatientChildMourning
 * 
 ...
 */
abstract class BasePatientChildMourning extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patient_child_mourning');

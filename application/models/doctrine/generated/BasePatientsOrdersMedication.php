...
Doctrine_Manager::getInstance()->bindComponent('PatientsOrdersMedication', 'MDAT');

/**
 * BasePatientsOrdersMedication
 * 
 ...
 */
abstract class BasePatientsOrdersMedication extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patients_orders_medication');

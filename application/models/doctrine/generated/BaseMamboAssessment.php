...
Doctrine_Manager::getInstance()->bindComponent('MamboAssessment', 'MDAT');
 ...
 * @property date $formular_date_start
 * @property date $formular_date_end
 * @property enum $contact_type_1
 * @property enum $contact_type_2
 * @property enum $contact_location
 * @property set $commitment
 * @property set $services_usage
 * @property string $formular_reason
 * @property string $comment
 * @property blob $_touched_ids
 ...
 */
abstract class BaseMamboAssessment extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('mambo_assessment');

<?php
	...
	abstract class BasePatientDrugPlanExtraAlt extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('patient_drugplan_extra_alt');
			...
			$this->hasColumn('importance', 'integer', 11, array('type' => 'integer', 'length' => 11));

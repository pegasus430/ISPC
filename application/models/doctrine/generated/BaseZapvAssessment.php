<?php
abstract class BaseZapvAssessment extends Doctrine_Record
{

	function setTableDefinition ()
	{
		$this->setTableName('zapv_assessment');
		...
		$this->hasColumn('symptom_33_checked', 'enum', null, array('type' => 'enum', 'notnull' => false, 'values' => array('0', '1')));
		$this->hasColumn('symptom_33_description', 'text', NULL, array('type' => 'string','length' => NULL));
		$this->hasColumn('symptom_35_checked', 'enum', null, array('type' => 'enum', 'notnull' => false, 'values' => array('0', '1')));
		$this->hasColumn('symptom_35_description', 'text', NULL, array('type' => 'string','length' => NULL));
		$this->hasColumn('symptom_36_checked', 'enum', null, array('type' => 'enum', 'notnull' => false, 'values' => array('0', '1')));
		$this->hasColumn('symptom_36_description', 'text', NULL, array('type' => 'string','length' => NULL));
		$this->hasColumn('symptom_38_checked', 'enum', null, array('type' => 'enum', 'notnull' => false, 'values' => array('0', '1')));
		$this->hasColumn('symptom_38_description', 'text', NULL, array('type' => 'string','length' => NULL));
		$this->hasColumn('symptom_37_checked', 'enum', null, array('type' => 'enum', 'notnull' => false, 'values' => array('0', '1')));
		$this->hasColumn('symptom_37_description', 'text', NULL, array('type' => 'string','length' => NULL));
		$this->hasColumn('symptom_34_checked', 'enum', null, array('type' => 'enum', 'notnull' => false, 'values' => array('0', '1')));
		$this->hasColumn('symptom_34_description', 'text', NULL, array('type' => 'string','length' => NULL));
		$this->hasColumn('symptom_39_checked', 'enum', null, array('type' => 'enum', 'notnull' => false, 'values' => array('0', '1')));
		$this->hasColumn('symptom_39_description', 'text', NULL, array('type' => 'string','length' => NULL));

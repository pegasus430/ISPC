<?php
	...
	abstract class BaseShInvoices extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('sh_invoice');
			...
			$this->hasColumn('sapv', 'int', 11, array('type' => 'bigint', 'length' => 11));
			$this->hasColumn('admissionid', 'int', 11, array('type' => 'bigint', 'length' => 11));
		...
		function setUp()
		{
		    ...
		    $this->hasMany('ShInvoiceItems', array(
		        'local' => 'id',
		        'foreign' => 'invoice'
		    ));
		    //--

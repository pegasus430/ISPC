...
Doctrine_Manager::getInstance()->bindComponent('AokprojectsKurzassessmentProblemCourse', 'MDAT');

/**
 * BaseAokProjectsKurzassessmentProblemCourse
 *
 * ISPC-2625, AOK Kurzassessment, 04.07.2020, elena
 * cloned from BaseAssessmentProblemCourse
 ...
 */
abstract class BaseAokprojectsKurzassessmentProblemCourse extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('aokprojects_kurzassessment_problem_course');

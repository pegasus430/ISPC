<?php
	...
	abstract class BasePatientReferredBy extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('patient_referredby');
			$this->hasColumn('id', 'integer', 11, array('type' => 'integer', 'length' => 8, 'primary' => true, 'autoincrement' => true));
			$this->hasColumn('referred_name', 'string', 255, array('type' => 'string', 'length' => 255));

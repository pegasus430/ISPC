...
Doctrine_Manager::getInstance()->bindComponent('MePatientRequestsProcessed', 'IDAT');

/**
 * BaseMePatientRequestsProcessed
 *
 ...
 *  ISPC-2432
 */
abstract class BaseMePatientRequestsProcessed extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('mePatient_requests_processed');

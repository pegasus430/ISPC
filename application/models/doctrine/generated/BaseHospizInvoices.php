<?php
	...
	abstract class BaseHospizInvoices extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('hospiz_invoice');
			...
			$this->hasColumn('sub_invoice_total', 'int', 11, array('type' => 'ingeger', 'length' => 11));
			$this->hasColumn('type', 'enum', null, array('type' => 'enum', 'notnull' => false, 'values' => array('private', 'normal')));

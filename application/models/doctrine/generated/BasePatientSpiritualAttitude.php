...
Doctrine_Manager::getInstance()->bindComponent('PatientSpiritualAttitude', 'IDAT');

/**
 * BasePatientSpiritualAttitude
 * 
 ...
 */
abstract class BasePatientSpiritualAttitude extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patient_spiritual_attitude');
        ...
        $this->hasColumn('selected_value', 'enum', 18, array(
             'type' => 'enum',
             'length' => 18,
             'fixed' => false,
             'unsigned' => false,

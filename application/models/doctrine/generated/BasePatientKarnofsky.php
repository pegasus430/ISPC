...
Doctrine_Manager::getInstance()->bindComponent('PatientKarnofsky', 'IDAT');

/**
 * BasePatientKarnofsky
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property integer $id
 * @property string $ipid
 * @property string $karnofsky
 ...
 */
abstract class BasePatientKarnofsky extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patient_karnofsky');
        ...
        $this->hasColumn('karnofsky', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             'fixed' => false,
             'unsigned' => false,

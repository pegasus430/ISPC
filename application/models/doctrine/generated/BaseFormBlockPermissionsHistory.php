...
Doctrine_Manager::getInstance()->bindComponent('FormBlockPermissionsHistory', 'SYSDAT');

/**
 * BaseFormBlockPermissionsHistory
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property integer $id
 * @property integer $clientid
 * @property integer $id_fbp
 ...
 */
abstract class BaseFormBlockPermissionsHistory extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('form_block_permissions_history');
        ...
        $this->hasColumn('id_fbp', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'fixed' => false,
             'unsigned' => false,

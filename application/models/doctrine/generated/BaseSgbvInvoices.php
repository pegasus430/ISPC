<?php
	...
	abstract class BaseSgbvInvoices extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('sgbv_invoice');
			...
			$this->hasColumn('start_sgbv', 'datetime', NULL, array('type' => 'datetime', 'length' => NULL));
			$this->hasColumn('end_sgbv', 'datetime', NULL, array('type' => 'datetime', 'length' => NULL));

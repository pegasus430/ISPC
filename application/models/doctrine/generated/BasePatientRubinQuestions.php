...
Doctrine_Manager::getInstance()->bindComponent('PatientRubinQuestions', 'MDAT');

/**
 * BasePatientRubinQuestions
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 * 
 * @property integer $id
 * @property enum $form_id
 * @property string $question_text
 * @property enum $question_type
 ...
 */
abstract class BasePatientRubinQuestions extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patient_rubin_questions');
        ...
        $this->hasColumn('question_order', 'integer', 3, array(
            'type' => 'integer',
            'length' => 3,
            'fixed' => false,
            'unsigned' => false,
        ...
        $this->hasColumn('question_text', 'string', null, array(
             'type' => 'string',
             'fixed' => false,
             'unsigned' => false,
             'primary' => false,
        ...
        $this->hasColumn('question_type', 'enum', 8, array(
             'type' => 'enum',
             'length' => 8,
             'fixed' => false,
             'unsigned' => false,
    ...
    public function setUp()
    {
        ...
        $this->hasMany('PatientRubinQuestionsOptions', array(
            'local' => 'question_id',
            'foreign' => 'question_id',
        ));

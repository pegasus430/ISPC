...
Doctrine_Manager::getInstance()->bindComponent('PatientsOrdersDetailsHistory', 'MDAT');

/**
 * BasePatientsOrdersDetailsHistory
 * 
 ...
 */
abstract class BasePatientsOrdersDetailsHistory extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patients_orders_details_history');

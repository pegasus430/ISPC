...
Doctrine_Manager::getInstance()->bindComponent('AssessmentProblemStatus', 'MDAT');

/**
 * BaseAssessmentProblemStatus
 * 
 ...
 */
abstract class BaseAssessmentProblemStatus extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('assessment_problem_status');
    ...
    public function setUp()
    {
        ...
        $this->hasOne('AssessmentProblems', array(

...
Doctrine_Manager::getInstance()->bindComponent('PatientAnlage33a', 'IDAT');

/**
 * BasePatientAnlage33a
 * 
 ...
 */
abstract class BasePatientAnlage33a extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('patient_anlage_3_3a');
        ...
        $this->hasColumn('selected_value', 'enum', 23, array(
             'type' => 'enum',
             'length' => 23,
             'fixed' => false,
             'unsigned' => false,

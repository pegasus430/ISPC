<?php
	...
	abstract class BaseHospiceassociation extends Pms_Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('hospice_association');
			...
			//--
			$this->hasColumn('hospice_association', 'string', 255, array('type' => 'string', 'length' => 255));

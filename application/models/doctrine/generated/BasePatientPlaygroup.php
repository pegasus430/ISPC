...
Doctrine_Manager::getInstance()->bindComponent('PatientPlaygroup', 'IDAT');


abstract class BasePatientPlaygroup extends Pms_Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('patient_playgroup');

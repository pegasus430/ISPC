...
Doctrine_Manager::getInstance()->bindComponent('MePatientSurveysClients', 'IDAT');

/**
 * BaseMePatientSurveysClients
 * 
 ...
 */
abstract class BaseMePatientSurveysClients extends Pms_Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('mePatient_surveys_clients');
    ...
    public function setUp()
    {
         ...
         */
        $this->hasOne('MePatientSurveys', array(
            'local' => 'survey_id',
            'foreign' => 'id',
        ));

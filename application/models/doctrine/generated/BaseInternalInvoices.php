<?php
	...
	abstract class BaseInternalInvoices extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('internal_invoices');
			...
			$this->hasColumn('street', 'text', NULL, array('type' => 'text', 'length' => NULL));
		...
		function setUp()
		{
			...
			$this->hasMany('InternalInvoiceItems', array(
			    'local' => 'id',
			    'foreign' => 'invoice'
			));

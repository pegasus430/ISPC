<?php
abstract class BaseClientSymptomsGroups extends Doctrine_Record
{
	function setTableDefinition()
	{
		$this->setTableName('client_symptoms_groups');
		...
		//--
		$this->hasColumn('groupname', 'string',NULL, array('type' => 'string','length' => NULL));

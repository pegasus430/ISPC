...
//ISPC-2736 Lore 12.11.2020
	abstract class BaseEmergencyPlanSapvIIMedication extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('emergency_plan_sapv_ii_medication');
		...
		function setUp()
		{
			...
			$this->hasOne('EmergencyPlanSapvII', array(
					'local' => 'planid',
					'foreign' => 'id'
			));
		}	

<?php
	...
	abstract class BaseBraSapvControl extends Doctrine_Record {

		function setTableDefinition()
		{
			$this->setTableName('bra_sapv_control');
			...
			$this->hasColumn('starter', 'integer', 1, array('type' => 'integer', 'length' => 1));

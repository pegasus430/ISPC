<?php
//ISPC-2672 Lore 16.10.2020

require_once("Pms/Form.php");

class Application_Form_PatientPlaygroup extends Pms_Form
{
    protected $_model = 'PatientPlaygroup';

    public function getVersorgerExtract($param = null)
    {
        return array(
            array( "label" => $this->translate('name_playgroup'), "cols" => array("name")),
        );
    }
    ...
    protected $_translate_lang_array = 'Form_PatientPlaygroup';
    
	   
	
	public function create_form_patient_playgroup($options =  array() , $elementsBelongTo = null)
	{
	    $__fnName = __FUNCTION__; //important, do not re-use this var on this fn
	    
	    $this->mapValidateFunction($__fnName, "create_form_isValid");
	    
	    $this->mapSaveFunction($__fnName, "save_form_playgroup");
	    
	    
	    $subform = new Zend_Form_SubForm();
	    $subform->removeDecorator('DtDdWrapper');
	    $subform->addDecorator('HtmlTag', array('tag' => 'table'));
	    $subform->setLegend($this->translate('PatientPlaygroup_legend'));
	    ...
	    $subform->addElement('checkbox', 'status', array(
	        ...
	        'onChange' => 'if ($(this).is(":checked")) {$(".show_playgroup_details", $(this).parents(\'table\')).removeClass(\'display_none\');} else {$(".show_playgroup_details", $(this).parents(\'table\')).addClass(\'display_none\');}',	        
	    ));
	    
	    $display_none = $options['status'] == '1' ? '' : "display_none";
	    
	    $subform->addElement('text', 'name', array(
	        'label'      => $this->translate('name_playgroup') ,
	        'value'      => $options['name'],
	        'required'   => false,
	        'filters'    => array('StringTrim'),
	        'validators' => array('NotEmpty'),
	        'decorators' => array(
	            ...
	            array(array('data' => 'HtmlTag'), array('tag' => 'td' )),
	            array('Label', array('tag' => 'td')),
	            array(array('row' => 'HtmlTag'), array('tag' => 'tr', 'class' => "show_playgroup_details {$display_none}" )),
	        ),
	    ));
	    ...
	    $lvpg_arr = PatientPlaygroup::getLastVisitPlaygroup();
	    $subform->addElement('multiCheckbox', 'last_visit', array(
	        'label'      => "last_visit",
	        'multiOptions' => $lvpg_arr,
	        'required'   => false,
	    ...
	    $subform->addElement('text',  'last_visit_text', array(
	        ...
	        'decorators' => array(
	            'ViewHelper',
	            array('Errors'),
	            array(array('data' => 'HtmlTag'), array('tag' => 'td', 'class' => "show_playgroup_details {$display_none}")),
	            array('Label', array('tag' => 'td', 'class' => "show_playgroup_details {$display_none}")),
	            array(array('row' => 'HtmlTag'), array( 'tag' => 'tr', 'class' => "show_playgroup_details {$display_none} last_visit_text_show ", 'style' => $display_last_visit_text,))
	        ),
	    ));
	    ...
	    $subform->addElement('text',  'last_visit_date', array(
	        ...
	        'decorators' => array(
	            ...
	            array(array('data' => 'HtmlTag'), array('tag' => 'td', 'class' => "show_playgroup_details {$display_none}")),
	            array('Label', array('tag' => 'td', 'class' => "show_playgroup_details {$display_none}")),
	            array(array('row' => 'HtmlTag'), array( 'tag' => 'tr', 'class' => "show_playgroup_details {$display_none} last_visit_date_show ", 'style' => $display_last_visit_date,))
	        ),
	        'class' => 'date',
	    ...
	    $subform->addElement('text', 'picked_up_text', array(
	        ...
	        'decorators'   => array(
	            ...
	            array(array('row' => 'HtmlTag'), array('tag' => 'tr', 'class' => "show_playgroup_details {$display_none} picked_up_text_from" , 'style' => $display_picked_up_text )),
	            ),
	    ));
	    ...
	    $subform->addElement('text', 'accom_required_text', array(
	        ...
	        'decorators'   => array(
	            ...
	            array(array('row' => 'HtmlTag'), array('tag' => 'tr', 'class' => "show_playgroup_details {$display_none} accom_required_text_by", 'style' => $display_accom_required_text )),
	            ),
	       ));
	    ...
	    $subform->addElement('radio',  'accom_pg_required', array(
	        ...
	        'label'        => $this->translate("accom_pg_required"),
	        'required'     => false,
	        'filters'      => array('StringTrim'),
	        'validators'   => array('NotEmpty'),
	        'decorators' => array(
	    ...
	    $subform->addElement('text', 'accom_pg_required_text', array(
	        ...
	        'decorators'   => array(
	            ...
	            array(array('row' => 'HtmlTag'), array('tag' => 'tr', 'class' => "show_playgroup_details {$display_none} accom_pg_required_text_by", 'style' => $display_accom_pg_required_text )),
	            ),
	    ));
	    ...
	    $subform->addElement('radio',  'aids_available', array(
	        ...
	        'label'        => $this->translate("aids_available"),
	        'required'     => false,
	        'filters'      => array('StringTrim'),
	        'validators'   => array('NotEmpty'),
	        'decorators' => array(
	    ...
	    $subform->addElement('text', 'aids_available_text', array(
	        ...
	        'decorators'   => array(
	            ...
	            array(array('row' => 'HtmlTag'), array('tag' => 'tr', 'class' => "show_playgroup_details {$display_none} which_aids_available", 'style' => $display_aids_available_text )),
	            ),
	    ));
	...
	public function save_form_playgroup($ipid =  null , $data = array())
	{
	    ...
	    if ($data['status'] == 0){
	        ...
	        $data['zip_mailbox'] = '';
	        $data['last_visit'] = '';
	        $data['last_visit_text'] = '';
	        $data['last_visit_date'] = '';
	        $data['picked_up'] = '';
	        $data['picked_up_text'] = '';
	        $data['accom_required'] = '';
	        $data['accom_required_text'] = '';
	        $data['accom_pg_required'] = '';
	        $data['accom_pg_required_text'] = '';
	        $data['aids_available'] = '';
	        $data['aids_available_text'] = '';
	        $data['description'] = '';
	    } else {
	    ...
	    $r = PatientPlaygroupTable::getInstance()->findOrCreateOneBy( ['id', 'ipid'], [$data['id'], $ipid], $data );

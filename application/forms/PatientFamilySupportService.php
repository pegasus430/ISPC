...
class Application_Form_PatientFamilySupportService extends Pms_Form
{
    protected $_model = 'PatientFamilySupportService';

    public function getVersorgerExtract($param = null)
    {
        return array(
            //array( "label" => $this->translate('first_name'), "cols" => array("first_name")),
            array( "label" => $this->translate('name'), "cols" => array("first_name", "last_name")),
            array( "label" => $this->translate('amount_time'), "cols" => array("amount_time")),
    ...
    protected $_translate_lang_array = 'Form_PatientFamilySupportService';
    
	   
	
    public function create_form_patient_family_support_service($options =  array() , $elementsBelongTo = null)
	{
	    $__fnName = __FUNCTION__; //important, do not re-use this var on this fn
	    
	    $this->mapValidateFunction($__fnName, "create_form_isValid");
	    
	    $this->mapSaveFunction($__fnName, "save_form_family_support_service");
	    
	    
	    $subform = new Zend_Form_SubForm();
	    $subform->removeDecorator('DtDdWrapper');
	    $subform->addDecorator('HtmlTag', array('tag' => 'table'));
	    $subform->setLegend($this->translate('PatientFamilySupportService_legend'));
	    ...
	    $subform->addElement('text', 'amount_time', array(
	        'value'        => $options['amount_time'] ,
	        'label'        => $this->translate('amount_time'),
	        'required'     => false,
	        'filters'      => array('StringTrim'),
	        'validators'   => array('NotEmpty'),
	        'decorators'   => array(
	    ...
	    $subform->addElement('text', 'func_cnt_person', array(
	        ...
	        'label'        => $this->translate('func_cnt_person'),
	        'required'     => false,
	        'filters'      => array('StringTrim'),
	        'validators'   => array('NotEmpty'),
	        'decorators'   => array(
	...
	public function save_form_family_support_service($ipid =  null , $data = array())
	{
	    ...
	    $r = PatientFamilySupportServiceTable::getInstance()->findOrCreateOneBy( ['id', 'ipid'], [$data['id'], $ipid], $data );

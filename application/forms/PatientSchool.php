...
class Application_Form_PatientSchool extends Pms_Form
{
    protected $_model = 'PatientSchool';

    public function getVersorgerExtract($param = null)
    {
        return array(
            array( "label" => $this->translate('Art'), "cols" => array("type_option")),
        );
    }
    ...
    protected $_translate_lang_array = 'Form_PatientSchool';
    
	   
	
	public function create_form_patient_school($options =  array() , $elementsBelongTo = null)
	{
	    $__fnName = __FUNCTION__; //important, do not re-use this var on this fn
	    
	    $this->mapValidateFunction($__fnName, "create_form_isValid");
	    
	    $this->mapSaveFunction($__fnName, "save_form_school");
	    
	    
	    $subform = new Zend_Form_SubForm();
	    $subform->removeDecorator('DtDdWrapper');
	    $subform->addDecorator('HtmlTag', array('tag' => 'table'));
	    $subform->setLegend($this->translate('PatientSchool_legend'));
	    ...
	    $type_arr = PatientSchool::getTypeSchool();
	    $subform->addElement('multiCheckbox', 'type', array(
	        'label'      => "Art",
	        'multiOptions' => $type_arr,
	        'required'   => false,
	        'value'    => isset($options['type']) && ! is_array($options['type']) ? array_map('trim', explode(",", $options['type'])) : $options['type'],
	        'filters'    => array('StringTrim'),
	        'validators' => array('NotEmpty'),
	        'decorators' => array(
	            'ViewHelper',
	    ...
	    $lvpg_arr = PatientSchool::getLastVisitSchool();
	    ...
	    $subform->addElement('radio',  'accom_pg_required', array(
	        ...
	        'label'        => $this->translate("accom_pg_required_school"),
	        'required'     => false,
	        'filters'      => array('StringTrim'),
	        'validators'   => array('NotEmpty'),
	        'decorators' => array(
	    ...
	    $subform->addElement('radio',  'aids_available', array(
	        ...
	        'label'        => $this->translate("aids_available_school"),
	        'required'     => false,
	        'filters'      => array('StringTrim'),
	        'validators'   => array('NotEmpty'),
	        'decorators' => array(
	...
	public function save_form_school($ipid =  null , $data = array())
	{
	    ...
	    $r = PatientSchoolTable::getInstance()->findOrCreateOneBy( ['id', 'ipid'], [$data['id'], $ipid], $data );

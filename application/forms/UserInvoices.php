<?php
	...
	class Application_Form_UserInvoices extends Pms_Form {
...
// 						$invoicenumber = $hi_invoice_number['invoicenumber'];
						...
						$update_inv = Doctrine_Core::getTable('UserInvoices')->findOneByIdAndStatusAndIsdeleteAndPrefix($v_inv_nr, '2', '0', 'TEMP_');
						//avoid errors
						if($update_inv)
						{

...
class Application_Form_PatientOtherSuppliers extends Pms_Form
{
    protected $_model = 'PatientOtherSuppliers';

    public function getVersorgerExtract($param = null)
    {
        return array(
            array( "label" => $this->translate('name_other'), "cols" => array("name")),
        );
    }
    ...
    protected $_translate_lang_array = 'Form_PatientOtherSuppliers';
    
	   
	
    public function create_form_patient_other_suppliers($options =  array() , $elementsBelongTo = null)
	{
	    $__fnName = __FUNCTION__; //important, do not re-use this var on this fn
	    
	    $this->mapValidateFunction($__fnName, "create_form_isValid");
	    
	    $this->mapSaveFunction($__fnName, "save_form_other_suppliers");
	    
	    
	    $subform = new Zend_Form_SubForm();
	    $subform->removeDecorator('DtDdWrapper');
	    $subform->addDecorator('HtmlTag', array('tag' => 'table'));
	    $subform->setLegend($this->translate('PatientOtherSuppliers_legend'));
	    ...
	    $subform->addElement('text', 'name', array(
	        'value'        => $options['name'] ,
	        'label'        => $this->translate('name_other'),
	        'required'     => false,
	        'filters'      => array('StringTrim'),
	        'validators'   => array('NotEmpty'),
	        'decorators'   => array(
	    ...
	    $lvpo_arr = PatientOtherSuppliers::getLastVisitOther();
	    $subform->addElement('multiCheckbox', 'last_visit', array(
	        'label'      => "last_visit",
	        'multiOptions' => $lvpo_arr,
	        'required'   => false,
	    ...
	    $subform->addElement('radio',  'accom_pg_required', array(
	        ...
	        'label'        => $this->translate("accom_pg_required_other"),
	        'required'     => false,
	        'filters'      => array('StringTrim'),
	        'validators'   => array('NotEmpty'),
	        'decorators' => array(
	    ...
	    $subform->addElement('radio',  'aids_available', array(
	        ...
	        'label'        => $this->translate("aids_available_other"),
	        'required'     => false,
	        'filters'      => array('StringTrim'),
	        'validators'   => array('NotEmpty'),
	        'decorators' => array(
	...
	public function save_form_other_suppliers($ipid =  null , $data = array())
	{
	    ...
	    $r = PatientOtherSuppliersTable::getInstance()->findOrCreateOneBy( ['id', 'ipid'], [$data['id'], $ipid], $data );

 ...
 *
 */
class Application_Form_PatientCareregulationnew extends Pms_Form
{
...
// 	        'onclick'      => '$(this).parents("form").attr("target", "_self"); return checkclientchanged(\'wlassessment_form\');',
	...
	public function create_form_patient_careregulationnew( $options = array(), $elementsBelongTo = null)
	{
	...
	private function _create_form_details_treatcare($options = array(), $elementsBelongTo = null)
	{
		...
		$form_details->setDecorators( array(
				'FormElements',
				array('HtmlTag', array('tag'=>'div', 'class'=>'separator ipad', 'style'=>'margin-top: 31px;'))
		));
		...
		$form_details->setDecorators( array(
				'FormElements',
				array('HtmlTag', array('tag'=>'div', 'class'=>'separator ipad_appoint', 'style'=>'padding-top: 20px;'))
		));
		$subform->addSubform($form_details, 'sep'.$this->_sp_index++);
		$this->_sp_index++;
		...
		$form_details->setDecorators( array(
				'FormElements',
				array('HtmlTag', array('tag'=>'div', 'class'=>'separator', 'style'=>'padding-top: 16px;'))
		));
		$subform->addSubform($form_details, 'sep'.$this->_sp_index++);
		$this->_sp_index++;
		...
		$form_details->setDecorators( array(
				'FormElements',
				array('HtmlTag', array('tag'=>'div', 'class'=>'separator', 'style'=>'padding-top: 18px;'))
		));
		$subform->addSubform($form_details, 'sep'.$this->_sp_index++);
		$this->_sp_index++;
		...
		$subform->addElement('text', 'wound_care_11', array(
				'value'        => '',
				'required'     => false,
				'filters'      => array('StringTrim'),
				'decorators' => array(
		...
		$form_details->setDecorators( array(
				'FormElements',
				array('HtmlTag', array('tag'=>'div', 'class'=>'separator ipad_wound_12', 'style'=>'padding-top: 15px;'))
		));
		$subform->addSubform($form_details, 'sep'.$this->_sp_index++);
		$this->_sp_index++;
		
		$subform->addElement('text', 'wound_care_12', array(
				'value'        => '',
				'required'     => false,
				'filters'      => array('StringTrim'),
				'decorators' => array(

 ...
 *
 */
class Application_Form_PatientAmbulantChildrenHospiceService extends Pms_Form
{
     ...
     */
    public function create_form_patient_ambulant_children_hospice_service($options =  array() , $elementsBelongTo = null)
    {
        $__fnName = __FUNCTION__; //important, do not re-use this var on this fn
	    
	    $this->mapValidateFunction($__fnName, "create_form_isValid");
	    
	    $this->mapSaveFunction($__fnName, "save_form_patient_ambulant_children_hospice_service");
	    
	    
	    $subform = new Zend_Form_SubForm();
	    $subform->removeDecorator('DtDdWrapper');
	    $subform->addDecorator('HtmlTag', array('tag' => 'table'));
	    $subform->setLegend($this->translate('PatientAmbulantChildrenHospiceService_legend'));
        ...
        $subform->addElement('text', 'name_of_children_hospice_service', array(
        		'value'        => $options['name_of_children_hospice_service'] ,
        		'label'        => $this->translate('name_of_children_hospice_service'),
        		'required'     => false,
        		'filters'      => array('StringTrim'),
        		'validators'   => array('NotEmpty'),
        		'decorators'   => array(
    ...
    public function save_form_patient_ambulant_children_hospice_service($ipid =  null , $data = array())
	{
	    ...
	    $r = PatientAmbulantChildrenHospiceServiceTable::getInstance()->findOrCreateOneBy( ['id', 'ipid'], [$data['id'], $ipid], $data );

...
/**
 * @author carmen
 * ISPC-2672 27.10.2020
 *
 */
class Application_Form_PatientIntegrationAssistance extends Pms_Form
{
    ...
    {
            return array(
            array( "label" => $this->translate('name_of_service_provider'), "cols" => array("name_of_service_provider")),
     ...
     */
    public function create_form_patient_integration_assistance($options =  array() , $elementsBelongTo = null)
    {
        $__fnName = __FUNCTION__; //important, do not re-use this var on this fn
	    
	    $this->mapValidateFunction($__fnName, "create_form_isValid");
	    
	    $this->mapSaveFunction($__fnName, "save_form_patient_integration_assistance");
	    
	    
	    $subform = new Zend_Form_SubForm();
	    $subform->removeDecorator('DtDdWrapper');
	    $subform->addDecorator('HtmlTag', array('tag' => 'table'));
	    $subform->setLegend($this->translate('PatientIntegrationAssistance_legend'));
        ...
        $subform->addElement('text', 'name_of_service_provider', array(
        		'value'        => $options['name_of_service_provider'] ,
        		'label'        => $this->translate('name_of_service_provider'),
        		'required'     => false,
        		'filters'      => array('StringTrim'),
        		'validators'   => array('NotEmpty'),
        		'decorators'   => array(
        ...
        $subform->addElement('text', 'amount_of_time', array(
        		'value'        => $options['amount_of_time'] ,
        		'label'        => $this->translate('amount_of_time'),
        		'required'     => false,
        		'filters'      => array('StringTrim'),
        		'validators'   => array('NotEmpty'),
        		'decorators'   => array(
    ...
    public function save_form_patient_integration_assistance($ipid =  null , $data = array())
	{
	    ...
	    $r = PatientIntegrationAssistanceTable::getInstance()->findOrCreateOneBy( ['id', 'ipid'], [$data['id'], $ipid], $data );

...
class Application_Form_PatientSapvTeam extends Pms_Form
{
    protected $_model = 'PatientSapvTeam';

    public function getVersorgerExtract($param = null)
    {
        return array(
            array( "label" => $this->translate('name_sapv'), "cols" => array("name_sapv")),
    ...
    protected $_translate_lang_array = 'Form_PatientSapvTeam';
    
	   
	
    public function create_form_patient_sapv_team($options =  array() , $elementsBelongTo = null)
	{
	    $__fnName = __FUNCTION__; //important, do not re-use this var on this fn
	    
	    $this->mapValidateFunction($__fnName, "create_form_isValid");
	    
	    $this->mapSaveFunction($__fnName, "save_form_sapv_team");
	    
	    
	    $subform = new Zend_Form_SubForm();
	    $subform->removeDecorator('DtDdWrapper');
	    $subform->addDecorator('HtmlTag', array('tag' => 'table'));
	    $subform->setLegend($this->translate('PatientSapvTeam_legend'));
	    ...
	    $subform->addElement('text', 'name_sapv', array(
	        'value'        => $options['name_sapv'] ,
	        'label'        => $this->translate('name_sapv'),
	        'required'     => false,
	        'filters'      => array('StringTrim'),
	        'validators'   => array('NotEmpty'),
	        'decorators'   => array(
	...
	public function save_form_sapv_team($ipid =  null , $data = array())
	{
	    ...
	    $r = PatientSapvTeamTable::getInstance()->findOrCreateOneBy( ['id', 'ipid'], [$data['id'], $ipid], $data );

<?php
	...
	class Application_Form_ClientInvoicePermissions extends Pms_Form {
		...
		public function insert_invoice_permissions($post)
		{
			if($post)
			{
				...
				if(count($perms_data) > '0')
				{
					...
					$collection = new Doctrine_Collection('ClientInvoicePermissions');
		...
		public function remove_permissions($clientid)
		{
			$q = Doctrine_Query::create()
				->update('ClientInvoicePermissions')
				->set('isdelete', "1")
